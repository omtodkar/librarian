...
const (
	...
	EdgeKindBodyReferences = "body_references" // symbol → symbol (PL/pgSQL function body read/write of a table or column; Metadata["op"]∈{read,write,both,procedure_call})
)
